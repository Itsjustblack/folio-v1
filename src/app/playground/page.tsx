...
function Card({ x, y }: { x: number; y: number }) {
	return (
		<motion.div
			...
			className="absolute w-[550px] h-[263px] bg-background cursor-grab active:cursor-grabbing rounded-[12px] p-3 z-10"
...
export default function Playground() {
	...
	return (
		...
		>
			...
			{/* Fixed Content */}
			<div className="absolute inset-0 z-5 flex flex-col items-center justify-end pointer-events-none">
				<div className="mb-25">
